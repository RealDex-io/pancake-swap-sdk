...
let PAIR_ADDRESS_CACHE: { [token0Address: string]: { [token1Address: string]: { [aFactor: string] : string } } } = {}
...
export class Pair {
  ...
  public static getAddress(tokenA: Token, tokenB: Token, aFactor: BigintIsh): string {
    ...
    if (PAIR_ADDRESS_CACHE?.[tokens[0].address]?.[tokens[1].address]?.[aFactor.toString()] === undefined) {
      PAIR_ADDRESS_CACHE = {
        ...PAIR_ADDRESS_CACHE,
        [tokens[0].address]: {
          ...
          [tokens[1].address]: {
            ...
            [aFactor.toString()]: getCreate2Address(
                FACTORY_ADDRESS,
  ...
  public constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount, aFactor: BigintIsh) {
    ...
    this.liquidityToken = new Token(
      ...
      Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, aFactor),
      18,
      'Cake-LP',
      'Pancake LPs'
    )
