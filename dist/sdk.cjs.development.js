...
var FACTORY_ADDRESS = '0xcc9944882df76302e06B1DC2dd62066e2e0Ef10F';
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[exports.ChainId.MAINNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[exports.ChainId.TESTNET] = '0xcc9944882df76302e06B1DC2dd62066e2e0Ef10F', _FACTORY_ADDRESS_MAP);
var INIT_CODE_HASH = '0x5ca9aae9c919af7433454981db460759a69c442c68bc9c359a733c7e4d260f34';
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[exports.ChainId.MAINNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[exports.ChainId.TESTNET] = '0x5ca9aae9c919af7433454981db460759a69c442c68bc9c359a733c7e4d260f34', _INIT_CODE_HASH_MAP);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, aFactor) {
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.aFactor = aFactor;
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, aFactor), 18, 'Cake-LP', 'Pancake LPs');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, aFactor) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$t === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(FACTORY_ADDRESS, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address', 'uint256'], [tokens[0].address, tokens[1].address, aFactor === null || aFactor === void 0 ? void 0 : aFactor.toString()])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    return [outputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.aFactor)];
  };
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    return [inputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.aFactor)];
  };
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var pairs = trade.route.pairs.map(function (pair) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          ...
          args = [amountOut, path, pairs, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountIn, amountOut, path, pairs, to, deadline];
          value = ZERO_HEX;
        } else {
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          ...
          args = [amountOut, amountIn, path, pairs, to, deadline];
          value = ZERO_HEX;
        } else {
